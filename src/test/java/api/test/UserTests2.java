...
public class UserTests2 {
    ...
    public void testUpdateUser() {
        ...
        Response updateResponse = UserEndpoints2.updateUser(this.userPayload.getUsername(), this.userPayload);
        updateResponse.then()
                .log().all()
        ...
        Response getUserResponse = UserEndpoints2.getUser(this.userPayload.getUsername());
